# Business Setup: Regulations, Licences, Taxes, Insurance

Researched 2026-08-19 for a two-partner handmade soap business in Kelowna, BC. All figures CAD. Verify fees before paying; sources linked throughout.
...
- **How:** filed online through Health Canada's cosmetic notification web system: company name/address, product name, product type (soap = rinse-off), area of application, full ingredient list with concentration ranges ([Modern Soapmaking CNF tutorial for Canada](https://www.modernsoapmaking.com/blog/cosmetic-notification-forms-tutorial-canada)).
- **One CNF per formulation.** Each recipe is a separate notification; **amend** when a formula, product name, or company address changes ([HBBG CNF guide](https://hbbg.ca/cnf-need-one/)).
- Health Canada screens against the [Cosmetic Ingredient Hotlist](https://www.canada.ca/en/health-canada/services/consumer-product-safety/cosmetics/cosmetic-ingredient-hotlist-prohibited-restricted-ingredients.html). Sodium hydroxide as a saponification ingredient in properly cured soap is standard and acceptable.
...
Governed by the Food and Drugs Act + Cosmetic Regulations + Consumer Packaging and Labelling Act ([Industry Guide for the Labelling of Cosmetics](https://www.canada.ca/en/health-canada/services/consumer-product-safety/reports-publications/industry-professionals/labelling-cosmetics.html)):

| Element | Requirement |
|---|---|
| Product identity | Principal display panel, **English and French** ("Soap / Savon") |
| Net quantity | Metric (grams), principal panel; the "g" symbol is bilingual |
| Ingredient list | **INCI names**, descending order by concentration; INCI is language-neutral |
| Maker name & address | Full postal address of manufacturer/distributor |
| Warnings | None required for plain cold-process soap (properly saponified soap has no free lye) |

INCI note: either raw-ingredient style (`Olea Europaea (Olive) Fruit Oil, Cocos Nucifera (Coconut) Oil, Water/Eau, Sodium Hydroxide`) or saponified style (`Sodium Olivate, Sodium Cocoate, Glycerin, Water/Eau`) is accepted.

**Weights gotcha:** cold-process bars lose water weight as they cure. Declare a net weight the bar will still meet at end of shelf life or you're short-weighting.
...
[Zoning Bylaw No. 12375, s.9.2](https://apps.kelowna.ca/CityPage/Docs/PDFs/Bylaws/Zoning%20Bylaw%20No.%2012375.pdf). A home business must stay secondary to residential use.
...
Ask Business Licensing (250-469-8617) for the plain-language Home-Based Business bulletins; the City's site blocks automated access.
...
1. Name Request (~$31) → register general partnership ($40); sign partnership agreement.
2. Register for **BC PST** (free) before first sale; skip GST until near $30k.
3. Kelowna **major home-based business licence** ($50 + annual fee, ~2 weeks).
4. **$2M product liability** via HBBG (~$500/yr) before first market.
5. Finalize bilingual labels (identity, net g, address, INCI list).
6. Sell, then file **CNF within 10 days** of each product's first sale (free).

**Year-one regulatory/setup cost, excluding supplies: ~$700-900.**
