# Labelling and Compliance (federal)
...
## 1. Forget the American soap blogs

**Canada has no "true soap" exemption.** That concept is US law (21 CFR 701.20), where soap made only of fatty-acid alkali salts and sold only for cleansing falls outside the FDA cosmetic definition. **Canada deliberately did not copy it.**

Verified directly: the word "soap" appears exactly **once** in the entire Cosmetic Regulations, incidentally, inside hair-dye patch-test instructions. There is **no definition of soap and no exemption for it**. The Food and Drugs Act s.2 definition governs:

> **cosmetic** includes any substance or mixture of substances manufactured, sold or represented for use in **cleansing**, improving or altering the complexion, skin, hair or teeth

Health Canada's own regulatory page explicitly names **"'handmade' cosmetics sold through home-based businesses or craft sales"** as included. A great deal of soap-making content online is US-derived and will mislead you badly.

Default CNF answers for a plain bar: **cosmetic · rinse-off · cleanser · solid-cake · area of application: body**.

---

## 2. The Cosmetic Notification Form

**Form (online, free): https://healthycanadians.gc.ca/apps/radar/CPS-SPC-0007.08.html**
...
|---|---|
| Soap, cleansing bar, gently cleanses | Antibacterial, antimicrobial, kills germs, sanitizing |
| **Moisturizing** (an approved CNF function) | Anti-acne, clears blemishes, for acne-prone skin |
| Gentle, for dry skin, leaves skin soft | Treats/heals eczema, psoriasis, dermatitis |
| Exfoliating (with oats) | Antifungal, anti-inflammatory, relieves pain |
| Unscented, fragrance-free, no dyes | Anti-dandruff, SPF, brightening/whitening |

An "antibacterial" bar needs an NPN or DIN **plus a site licence with an NHP GMP quality system** including a signed Quality Assurance Report. Not viable from a home kitchen at this budget.

**Also watch CR s.21(1):** any claim about influencing skin chemistry, or implying the user won't suffer injury, requires **evidence on file** producible to the Minister on request. So "moisturizing" is fine as a category, but "restores your skin barrier" or "hypoallergenic" needs substantiation.

### "Natural," "eco-friendly," and cruelty-free
- The Competition Act's greenwashing rules changed **March 26, 2026**, removing the "internationally recognized methodology" requirement. What remains: environmental claims need **adequate and proper testing/substantiation**, judged on **general impression**, not just literal meaning.
- Safe because factual: palm-free, plastic-free packaging, no added fragrance.
- Risky and vague: eco-friendly, sustainable, zero waste, non-toxic.
- **"Chemical-free" is literally false for soap** and would breach CPLA s.7(1).
- **"Cruelty-free"** requires documented evidence covering your whole ingredient supply chain (FDA s.16.3, in force Dec 2023). Get written supplier attestations or skip the claim.

---

## 4. What goes on the label

A banded bar has **one label**, so it must carry everything (CR s.19).
...
### The lye question, corrected
CR s.2 defines "ingredient" to **exclude** "substances that are used in the preparation of the cosmetic but that are not present in the final product as a result of the chemical process."

In properly cured cold-process soap the NaOH is fully consumed. So the compliant list is the **saponified salts**, plus any superfat oils that remain unreacted:

> Sodium Olivate, Sodium Cocoate, Aqua/Water/Eau, Glycerin
...
## 5. Why scent-free is worth real money here
...
**An unscented bar skips this section entirely.** That's a genuine, quantifiable advantage of the positioning, on top of the marketing one.
...
1. Decide claims; ban the drug words everywhere including social media.
2. Run every ingredient through the CNF form's Search Ingredient button (free Hotlist + INCI).
3. Email Health Canada to confirm the saponified-salt ingredient listing.
4. Design the band: identity bilingual, net weight in bold grams, INCI list, email contact, dealer address.
5. Weigh after cure; label conservatively.
6. **File the CNF within 10 days of the first market day.** Save the `.hcxs`.
7. Start the batch log, complaint file, and per-recipe safety file on day one.
8. Amend or discontinue the CNF within 10 days of any change.
